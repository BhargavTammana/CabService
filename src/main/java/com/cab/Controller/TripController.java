...
public class TripController {
	...
	public ResponseEntity<Float> calculateFare(@RequestParam("cabId") Integer cabId, @RequestBody TripBooking tripBooking, @RequestParam("uuid") String uuid) throws TripBookingException, CabException, CurrentUserSessionException{
		return new ResponseEntity<Float>(tripBookingService.calculateTripFare(cabId, tripBooking, uuid),HttpStatus.OK);
	}
